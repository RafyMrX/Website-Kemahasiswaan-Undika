...
<div class="row header-filter">
  ...
  <div class="col-md-3">
    <a href="{{url('/draft')}}" class="btn btn-danger drft"><img src="{{url('assets/back/dist/icon/draft.png')}}" width="21">  Draft</a>
      ...
      <tbody>
        <tr>
          ...
          <td class="text-center">
            ...
            <a href="#" class="link-action" ><i class="fa fa-eye fa-lg"></i></a>
